...
* **Custom 3D Environments:** Beautifully crafted 3D assets and immersive environments modeled from scratch using **Blender**.
...
* **AI Summarization:** Leverage on-device **Foundation Models** to automatically generate concise summaries of your reading notes.
